...
(function() { this.JST || (this.JST = {}); this.JST["artists/artist_index"] = function(obj){var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('');  if(main == true) { ; __p.push('\n  <div class="row main-artist">\n');  } else { ; __p.push('\n  <li class="artist">\n');  } ; __p.push('\n  <img src=',  artist['image'][3]['#text'],'></img>\n  <p>\n    ',  artist['name'],'\n    ');  if(playcount == true) { ; __p.push('\n      Playcount: ',  artist['playcount'] ,'\n    ');  } ; __p.push('\n  </p>\n  ');  if(artist['match'] != undefined ) { ; __p.push('\n    <meter value=', artist['match'],' min=0 max=1></meter>\n  ');  } ; __p.push('\n</li>\n');}return __p.join('');};
}).call(this);
(function() { this.JST || (this.JST = {}); this.JST["artists/artist_item"] = function(__obj) {
    if (!__obj) __obj = {};
    ...
    (function() {
      (function() {
        __out.push('<input class="toggle" type="checkbox" ');
      
        __out.push(__sanitize(typeof listened !== "undefined" && listened !== null ? listened : {
          'checked': ''
        }));
      
        __out.push('>\n<label>');
      
        __out.push(__sanitize(this.artist.get('name')));
...
(function() { this.JST || (this.JST = {}); this.JST["artists/artist_stats"] = function(__obj) {
    if (!__obj) __obj = {};
    var __out = [], __capture = function(callback) {
      var out = __out, result;
      __out = [];
    ...
    (function() {
      (function() {
        __out.push('<div class="artist-count">');
      
        __out.push(__sanitize(this.remaining));
      
        __out.push(' artists left.</div>\n<div class="artist-clear">\n  <a class="clear-listened">Clear ');
      
        __out.push(__sanitize(this.listened));
      
        __out.push(' listened artists</a>\n</div>\n');
